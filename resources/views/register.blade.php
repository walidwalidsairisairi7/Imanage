...
<body>
    <form class="form_container" method="GET">
        ...
        <div class="input_container">
            ...
            <input placeholder="name" title="name" name="name" type="text" class="input_field" id="name">
          </div>
        <div class="input_container">
          ...
          <input placeholder="name@mail.com" title="email" name="email" type="text" class="input_field" id="email">
        </div>
        <div class="input_container">
          ...
          <input placeholder="Password" title="password" name="password" type="password" class="input_field" id="password">
        </div>
