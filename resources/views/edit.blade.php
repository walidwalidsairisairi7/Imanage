...
@section('content')
<div id="hna" class="w-full overflow-x-auto">
    <table  class="w-full whitespace-no-wrap">
        ...
        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            ...
            <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center text-sm student-details" data-toggle="popover" data-placement="right" title="{{$rs->nom}} {{$rs->prenom}}" data-content="Phone: {{$rs->phone}}<br>Email: {{$rs->email}}<br>Date of Birth: {{$rs->dateN}}">
