...
@section('content')
  <div class="w-full max-w-[300px] bg-white rounded-lg shadow-md p-6">
    ...
    <form action="{{ route('teachers.store') }}" method="POST" class="flex flex-col">
      @csrf
        <input type="text" class="bg-gray-100 text-gray-800 border-0 rounded-md p-2 mb-4 focus:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150" name="nom" placeholder="First Name">
        ...
        <button type="submit" class="button">ADD teachers</button>
    </form>
  </div>
@endsection