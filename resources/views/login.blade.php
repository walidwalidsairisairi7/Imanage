...
<body>
    <form class="form_container" method="POST" >
        ...
        <div class="input_container">
            ...
            <input placeholder="name@mail.com" title="Input title" name="email" type="text" class="input_field" id="email" value="{{ old('email') }}">
        </div>
        @error('email')
        ...
        <div class="input_container">
            ...
            <input placeholder="Password" title="Input title" name="password" type="password" class="input_field" id="password">
        </div>
        @error('password')
            <div class="error_message">{{ $message }}</div>
        @enderror
...
<body>
    <form class="form_container"  method="GET">
        ...
        <div class="input_container">
          ...
          <input placeholder="name@mail.com" title="Inpit title" name="email" type="text" class="input_field" id="email">
        </div>
        <div class="input_container">
          <label class="input_label" for="password_field">Password</label>
          <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
          ...
          <input placeholder="Password" title="Inpit title" name="password" type="password" class="input_field" id="password">
        </div>
        <button title="Sign In" type="submit" class="sign-in_btn">
          <span>Sign In</span>
        </button>
